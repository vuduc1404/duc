# --- File: auto_video_app_voicevox.py ---
...
class AutoVideoCreator:
    ...
    def init_ui(self):
        ...
        self.effect_option = None  # sẽ gán bên dưới
    ...
    def update_input_type_ui(self, event=None):
        ...
        if is_video:
            ...
            self.video_label.grid(row=1, column=1, columnspan=3, sticky="w", padx=5, pady=5)
    ...
    def select_videos(self):
        paths = filedialog.askopenfilenames(filetypes=[("Videos", "*.mp4 *.avi *.mov *.mkv")])
        if paths:
            ...
            if use_video:
                ...
                tasks.append(
                    render_shard(
                        ...
                        "video",  # truyền effect là 'video' cho phân biệt
