...
VALID_KEYS = ["bcwiwKSggLh7dx8H2ypr", "XnmBWxX3gKCLprwtpDFu", "H8zL950vaWVx5IM1r2hJ", "MordZo2TrD2zCE1z2lUK", "lnAGE8Pxb1XmXpiTrPf5", "EohgF6lJYeFtlPeGK5hb", "tSKgteeuS8ZQBEdtiWXo", "347yDoO2qpcs6Nfp4E7F", "1WoEOM7HcqvZQ0QTHNh2", "bqbpWJIWuhvz2IgGgABK", "kN0HlBmKxLg5x8jdGrcv", "4R9iQBDEF935FuEn2mBV", "EpVCplm1y98TJ9MvqsAM", "wPlSlCKtnT5nXBszhPXb", "rsVCoxlDXeygPzMW8G5f", "TG9w3RdKu8RITBRrYXct", "9oSH9kqplXQwfPVknAqZ","JLsQlEC1Jd7BfA6PBtH1", "ORrmqmFDu1oDUHVHBFV7", "yPcSs5TmHwxQ3utPYphT",]  # Thay bằng key thật của bạn
...
class AutoVideoCreator:
    ...
    def update_input_type_ui(self, event=None):
        ...
        if is_video:
            ...
            # Thêm combobox hiệu ứng cho video
            ...
            if use_video:
                ...
                tasks.append(
                    render_shard(
                        ...
                        effects_dir=EFFECTS_DIR # truyền đường dẫn effects
                    )
                )
            else:
                tasks.append(
